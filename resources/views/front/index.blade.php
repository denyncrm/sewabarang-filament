						...
						<div class="flex flex-col gap-3 bg-white">
							<div class="h-[130px] flex shrink-0 items-center rounded-2xl overflow-hidden bg-[#F6F6F6]">
								<div class="h-[70px] w-full flex shrink-0 justify-center">
									<img src="{{Storage::url($latest_product->thumbnail)}}" class="w-full h-full object-contain" alt="thumbnail" />
								</div>
							</div>
							<div class="flex flex-col gap-1">
								<p class="font-semibold break-words">{{ $latest_product->name }}</p>
								<div class="flex items-center justify-between">
									<p class="text-sm leading-[21px] text-[#6E6E70]">{{ $latest_product->category->name }}</p>
